...
namespace hob {
    ...
    bool LuaPathSchemaRegistry::write_to_file(const std::filesystem::path& path) const {
        ...
        if (!f) {
            log::lua.error("LuaPathSchemaRegistry: failed to open '{}' for writing", path.string());
            return false;
        }
    ...
    bool LuaPathSchemaRegistry::write_meta_to_file(const std::filesystem::path& path) const {
        std::ostringstream out;
        out << "---@meta\n";
        out << "-- AUTO-GENERATED by LuaPathSchemaRegistry. Do not edit by hand.\n";
        out << "-- Source of truth: hob:: bind_path_schema(...) calls in lua_bind_assets.cpp.\n\n";
